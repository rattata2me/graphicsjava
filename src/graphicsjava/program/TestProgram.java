...
import graphicsjava.d3.Object3D;
import graphicsjava.d3.TrianglesObject3D;
import graphicsjava.math.Graph;
...
public class TestProgram extends Program{
    ...
    public TestProgram(ProgramConfig config) {
        super(config);
    }
    ...
    public void onStart() {
        ...
        cube = new TrianglesObject3D(cubeMesh);
    }
